...
Eigen::Matrix4f get_projection_matrix(float eye_fov, float aspect_ratio,
  ...
  // TODO: Copy-paste your implementation from the Assignment1.
...
int main(int argc, const char** argv) {
  ...
  std::vector<Eigen::Vector3f> pos{{2, -3, -2},    {0, 4, -4},
                                   {-2, -3, -2},   {3.5, -1, -5},
                                   {2.5, 1.5, -5}, {-1, 0.5, -5}};

  std::vector<Eigen::Vector3i> ind{{0, 1, 2}, {3, 4, 5}};

  std::vector<Eigen::Vector3f> cols{{232, 117, 166}, {232, 117, 166},
                                    {232, 117, 166}, {0, 100, 0},
                                    {0, 100, 0},     {0, 100, 0}};
