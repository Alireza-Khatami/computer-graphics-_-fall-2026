...
void rst::rasterizer::draw(pos_buf_id pos_buffer, ind_buf_id ind_buffer,
    ...
    for (auto& i : ind) {
        ...
        if (cull_mode != CullMode::None) {
            ...
            //    you should check 
            //          1-2what if the culling mode is BACK and the triangle is facing away or twoards the camera 
            //          3-4or culling mode is FRONT and the triangle is facing away or twoards the camera 
...
void rst::rasterizer::rasterize_triangle(const Triangle& t) {
  ...
  // w_reciprocal;
  //
  // Step 2.2:   if (blend_mode == blenmode::depth_test) {
            ...
            // } 
            // else {
            //    Use the alpha blending to set the pixel color (use the
            //}
}
