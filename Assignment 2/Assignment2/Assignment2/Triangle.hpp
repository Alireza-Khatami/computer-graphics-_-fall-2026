...
class Triangle {
 public:
  ...
  /*Per vertex values*/
  Vector4f color[3];       // color at each vertex;
  ...
  void setColor(int ind, float r, float g, float b, float a); /*set i-th vertex color*/
  Vector4f getColor() const {
    return Vector4f(color[0][0] * 255, color[0][1] * 255, color[0][2] * 255, color[0][3]);
