...
Eigen::Matrix4f get_projection_matrix(float eye_fov, float aspect_ratio,
    ...
    // Create the projection matrix for the given parameters and return it.
    // This is a standard perspective projection matrix for a right-handed system.
    Eigen::Matrix4f projection = Eigen::Matrix4f::Zero();

    float fov_rad = eye_fov * MY_PI / 180.0f;
    // Top of the near plane
    float t = std::tan(fov_rad / 2.0f) * zNear;
    // Bottom of the near plane
    float b = -t;
    // Right of the near plane
    float r = t * aspect_ratio;
    // Left of the near plane
    float l = -r;

    // Map coordinates to NDC [-1, 1]
